...
import { convertPDFToExcel, downloadBlob, type DocumentConversionOptions } from "@/lib/realPdfUtils";
    ...
    <>
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-8">
          <div className="w-16 h-16 bg-green-600 rounded-2xl flex items-center justify-center text-white text-xl mx-auto mb-4" role="img" aria-label="PDF to Excel conversion tool">
            <i className="fas fa-file-excel" aria-hidden="true"></i>
          </div>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">PDF to Excel</h1>
          <p className="text-gray-600 dark:text-gray-300 max-w-xl mx-auto leading-relaxed">
            Extract tables and data from PDF to Excel spreadsheet
          </p>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 mb-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    <Label className="text-sm font-medium text-gray-700 dark:text-gray-300">Auto-detect Tables</Label>
                    <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                      Automatically identify and structure table data
                    </p>
                  </div>
                  <Switch
              ...
              <div className="mt-4 p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
                <p className="text-sm text-green-700 dark:text-green-300">
                  ...
                  The converted data will be saved as an .xlsx file that you can open in Excel or Google Sheets.
                </p>
              </div>
            </div>
